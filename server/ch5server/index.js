...
app.post('/login', (req, res) => {
    ...
    var url = 'https://api.weixin.qq.com/sns/jscode2session?appid=' + 'wx8ca4e3b43afbf790' + '&secret=' + '884eb76a2e67bd460cca5943935309e4' + '&js_code=' + req.body.code + '&grant_type=authorization_code'
